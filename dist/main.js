  ...
  (a.m = n),
    ...
    (function () {
      ...
      var t = function (t, n) {
        ...
        n = (self.webpackChunkyakitori_app =
          self.webpackChunkyakitori_app || []);
    ...
    (function () {
      ...
      function P(e, t, n) {
        ...
        let l = null;
        for (let e = 0; null == l && e < a.length; ++e) l = U(a[e], A(r));
        return l;
      }
      function N(e, t, n, r) {
        void 0 === t && (t = []),
        ...
        let a = (e, a, l) => {
          ...
          e.children &&
            ...
            N(e.children, t, i, u)),
            (null != e.path || e.index) &&
              t.push({ path: u, score: I(u, e.index), routesMeta: i });
        };
        return (
          e.forEach((e, t) => {
            var n;
            if ('' !== e.path && null != (n = e.path) && n.includes('?'))
              for (let n of z(e.path)) a(e, t, n);
            else a(e, t);
          }),
          t
        );
      ...
      function I(e, t) {
        ...
        return (
          ...
          n
            .filter((e) => !D(e))
            .reduce((e, t) => e + (L.test(t) ? T : '' === t ? O : M), r)
        );
      }
      function U(e, t) {
        let { routesMeta: n } = e,
        ...
        let i = (function (e, t) {
            ...
            let {
              ...
              l = n
                ...
                : t;
            return { pathname: l, search: K(r), hash: q(a) };
          })(a, l),
          s = u && '/' !== u && u.endsWith('/'),
          c = (o || '.' === u) && n.endsWith('/');
      ...
      const Z = t.createContext(null),
        ...
        re = t.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
        ae = t.createContext(null);
      function le() {
        return null != t.useContext(ne);
      }
      function oe() {
        return le() || w(!1), t.useContext(ne).location;
      }
      function ue(e) {
        t.useContext(te).static || t.useLayoutEffect(e);
      }
      function ie() {
        ...
        return e
          ? (function () {
              let { router: e } = (function (e) {
                  ...
                  return n || w(!1), n;
                })(me.UseNavigateStable),
                n = ye(ve.UseNavigateStable),
                r = t.useRef(!1);
              ue(() => {
                r.current = !0;
              });
          ...
          : (function () {
              le() || w(!1);
              let { basename: e, navigator: n } = t.useContext(te),
                { matches: r } = t.useContext(re),
                { pathname: a } = oe(),
              ...
              let u = t.useCallback(
                function (t, r) {
                  ...
                  let u = V(t, JSON.parse(l), a, 'path' === r.relative);
                  '/' !== e &&
                    (u.pathname = '/' === u.pathname ? e : H([e, u.pathname])),
      ...
      function se(e, n) {
        ...
        return t.useMemo(
          () => V(e, JSON.parse(o), l, 'path' === r),
          [e, o, l, r]
        );
      }
      function ce(n, r, a) {
        le() || w(!1);
        let { navigator: l } = t.useContext(te),
          { matches: o } = t.useContext(re),
          u = o[o.length - 1],
          i = u ? u.params : {},
      ...
      const de = t.createElement(fe, null);
      ...
      function we(n) {
        ...
        let s = r.replace(/^\/*/, '/'),
          c = t.useMemo(
            () => ({ basename: s, navigator: u, static: i }),
            [s, u, i]
          );
        ...
        return null == v
          ...
          : t.createElement(
              te.Provider,
              { value: c },
              t.createElement(ne.Provider, { children: a, value: v })
            );
      }
      function ke(e) {
        ...
        return (
          t.Children.forEach(e, (e, a) => {
            ...
            if (e.type === t.Fragment)
              return void r.push.apply(r, Ee(e.props.children, l));
            e.type !== be && w(!1), e.props.index && e.props.children && w(!1);
            let o = {
            ...
            e.props.children && (o.children = Ee(e.props.children, l)),
              r.push(o);
          }),
          r
        );
              ...
              (function (t, n, r, a) {
                ...
                function d() {
                  ...
                  let t = f(),
                    n = null == t ? null : t - c;
                  (c = t),
                    s && s({ action: i, location: h.location, delta: n });
                }
                function p(e) {
                  let t =
                ...
                null == c &&
                  ((c = 0), u.replaceState(y({}, u.state, { idx: c }), ''));
                let h = {
                  get action() {
                    return i;
                  },
                  ...
                  listen(e) {
                    ...
                    return (
                      ...
                      (s = e),
                      () => {
                        l.removeEventListener(b, d), (s = null);
                      }
                    );
                  },
                  createHref(e) {
                  ...
                  replace: function (t, n) {
                    ...
                    u.replaceState(l, '', d),
                      o &&
                        s &&
                        s({ action: i, location: h.location, delta: 0 });
                  },
                  go(e) {
                    return u.go(e);
                  },
      ...
      const Pe =
        ...
        ze = t.forwardRef(function (e, n) {
          let r,
            ...
            { basename: p } = t.useContext(te),
            h = !1;
          if ('string' == typeof c && Ne.test(c) && ((r = c), Pe))
            try {
          ...
          let m = (function (e, n) {
              let { relative: r } = void 0 === n ? {} : n;
              le() || w(!1);
              let { basename: a, navigator: l } = t.useContext(te),
                { hash: o, pathname: u, search: i } = se(e, { relative: r }),
                s = u;
              return (
                '/' !== a && (s = '/' === u ? a : H([a, u])),
                l.createHref({ pathname: s, search: i, hash: o })
              );
            })(c, { relative: l }),
            v = (function (e, n) {
              let {
      ...
      var Re,
        Oe = function () {
          return t.createElement(
            'div',
            null,
            t.createElement('h1', null, 'Welcome to our Yakitori restaurant!')
          );
        },
        Me = function (e) {
          var n = e.name,
        ...
        De = function () {
          return t.createElement(
            ...
            Fe.map(function (e) {
              return t.createElement(
                ze,
                { to: '/menu/'.concat(e.id), key: e.id },
                t.createElement(Me, { name: e.name, price: e.price })
              );
            })
          );
        },
        ...
        je = function () {
          ...
          if (void 0 === e) return t.createElement('div', null, ' Invalid ID.');
          var n = Ue.find(function (t) {
          ...
          return n
            ? t.createElement(
                'div',
                null,
                t.createElement('h1', null, n.name),
                t.createElement('p', null, n.price, ' yen'),
                t.createElement('p', null, n.description)
              )
            : t.createElement('div', null, 'Menu item not found.');
        },
        Ae = function () {
          return t.createElement(
            _e,
        ...
        Be = function () {
          return t.createElement(
            'nav',
            null,
            t.createElement(ze, { to: '/' }, 'Home'),
            t.createElement(ze, { to: '/menu' }, 'Menu')
          );
        },
        $e = function () {
          return t.createElement(
      ...
      n
        ...
        .render(t.createElement(t.StrictMode, null, t.createElement($e, null))),
        Re &&
          Re instanceof Function &&
          a
            .e(131)
            .then(a.bind(a, 131))
            .then(function (e) {
